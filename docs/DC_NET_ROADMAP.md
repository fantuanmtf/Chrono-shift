...
v0.0.8.3 去 Windows 化          ✅ 完成 (2026-08-15)
v0.0.9 安全加固(低阶点/认证门控/Web Token/抗女巫/资源上限) ✅ 当前
```
...
| 高 | 独立安全评审 | 找第三方审计会话/轮次/中继三条路径(2026-08 内部审计已完成 v0.0.9 修复) |
